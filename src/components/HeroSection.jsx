      ...
      <div className="container max-w-4xl mx-auto text-center z-10 flex flex-col items-center justify-center space-y-10">
        ...
        <div className="space-y-4 mt-32">
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight">
            <span className="opacity-0 inline-block animate-fade-in">
              Hi, I'm
            </span>
            <span className="text-glow inline-block opacity-0 ml-2 animate-fade-in-delay-1">
              {" "}
              Maaz{" "}
            </span>
            <span className="text-glow inline-block ml-2 opacity-0 animate-fade-in-delay-2">
              {" "}
              Shahid
            </span>
          </h1>
